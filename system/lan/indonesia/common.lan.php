...
------------------------------------
*/
$_L['Secret'] = 'Kata Sandi';
$_L['Login_Method'] = 'Metode Login';
$_L['Voucher_Code'] = 'Kode Voucher';
$_L['Username_Password'] = 'Username dan Password';
$_L['Hotspot Domain'] = 'Domain Hotspot';
$_L['Login'] = 'Masuk'; 
$_L['Register'] = 'Daftar';
$_L['Announcement'] = 'Pengumuman';
$_L['Registration_Info'] = 'Info Pendaftaran';
$_L['Register_Voucher_Failed'] = 'Voucher Tidak Ditemukan<br>Silahkan Beli Voucher Sebelum Mendaftar';
$_L['Register_Success'] = 'Registrasi Berhasil<br>Silahkan Login';
...
$_L['Voucher_Not_Valid'] = 'Kode Voucher Tidak Tersedia';
