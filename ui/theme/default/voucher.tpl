						...
						<table id="datatable" class="table table-striped table-bordered">
							...
							{foreach $d as $ds}
								<tr>
									...
									<td>{$ds['code']}</td>
									<td>{$ds['secret']}</td>
									<td align="center">{if $ds['status'] eq '0'} <label class="btn-tag btn-tag-success">New Voucher</label> {else} <label class="btn-tag btn-tag-danger">Old Voucher</label> {/if}</td>
									<td>
